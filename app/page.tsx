...
export default function Page() {
  ...
  const cursos = [
    ...
    {
      title: '🧠 Curso de Comportamento',
      desc: 'Desenvolva inteligência emocional.',
  ...
  const mentorias = [
    {
      ...
      desc: 'Mentorias completas de desenvolvimento.',
  ...
  const videoAulas = [
    {
      title: '🎥 Video Aulas Premium',
      desc: 'Aulas rápidas e didáticas.',
